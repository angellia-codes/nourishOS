 ...
 */
export const sendComplianceAlerts = onSchedule(
  { schedule: '0 17 * * *', timeZone: BUSINESS_TIME_ZONE, region: REGION, secrets: [FONNTE_TOKEN] },
  async () => {
    ...
    for (const leaderDoc of leadersSnap.docs) {
      ...
      try {
        ...
        await sendNotificationInternal({
          ...
          // §9.11's "Daily update not submitted → Dept. Manager, daily 17:00" row.
          whatsapp: true,
        })
      } catch (error) {
