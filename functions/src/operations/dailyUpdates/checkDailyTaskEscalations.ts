...
/** daily-updates.md §5/§6, HR_OPERATIONS.md §9.12-F06 (escalation over WhatsApp at D+2/+3/+5). Runs at 07:00, after carryForwardDailyTasks. Idempotent via escalationLevel — only escalates when daysOpen crosses a threshold AND escalationLevel is still below it. */
export const checkDailyTaskEscalations = onSchedule(
