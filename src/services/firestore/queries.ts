 ...
 *
 * Constraints are real Firestore query constraints, so filtering, ordering,
 * and limiting are pushed down to the server rather than applied in the
 * browser after fetching the whole collection.
 */
