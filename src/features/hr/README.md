...
- **`recruitment/`** — the hiring pipeline, four stages chained end to end:
  - **Requisitions** (`/hr/requisitions`) — manpower requests. Draft → HR Manager → GM; the vacancy only
    opens once the Approval Engine resolves the request (`hr/requisition` route).
  - **Candidates** (`/hr/candidates`) — the board, ST-01 Applied through ST-08 Withdrawn. Every candidate
  ...
  - **Onboarding** (`/hr/onboarding`) — the F01 document checklist, generated when a candidate is hired.
